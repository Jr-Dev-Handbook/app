    ...
    <div class="max-w-7xl mx-auto py-6 px-4 sm:py-8 sm:px-6 lg:px-8 lg:py-10">
      <div class="text-center">
        ...
        <p class="max-w-xl mt-5 mx-auto text-xl text-gray-500">
          We have currently {{ tips.length }} tips in our list
        </p>
    ...
    <ul class="grid grid-cols-1 gap-y-6 gap-x-12 sm:grid-cols-2 lg:grid-cols-2">
      ...
      >
        <router-link :to="{ name: 'SingleTip', params: { id: tip._id } }">
          <div
            class="w-full flex items-center justify-between p-6 space-x-6 h-48"
          >
    ...
    <div class="flex flex-col">
      <div class="flex flex-col px-10 h-full mb-6">
        <a
          ...
          target="_blank"
          rel="noreferrer"
          href="https://stats.gallery/"
          ><div class="rounded-l-full py-3 pl-4 pr-3 flex">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              class="w-6 h-6"
              viewBox="0 0 67.526 76.5703"
              fill="currentColor"
            >
              <path
                class="cls-1"
                d="M37.8925,23.1852C30.964,37.3934,24.2679,51.1273,17.5691,64.86c-1.4565,2.9859-3.015,5.9266-4.3443,8.9678a2.7152,2.7152,0,0,1-3.04,1.845C7.2821,75.56,4.3717,75.64,1.4778,75.64c-.23-1.0363.3866-1.7017.7391-2.4179Q19.5456,38.0088,36.9191,2.8177c.3529-.7151.44-1.8821,1.3478-1.9241.9712-.0449,1.0345,1.1519,1.38,1.8516Q52.8455,29.4379,66.028,56.1384c.8479,1.71,1.1321,2.6369-1.3688,2.4124-2.801-.2514-6.1589.9952-8.287-.4546-2.0074-1.3676-2.7858-4.5738-4.0439-7.0028Q45.9092,38.7012,39.5325,26.2871C39.0838,25.4171,38.6179,24.5559,37.8925,23.1852Z"
              />
            </svg>
          </div>
          <div
            class="hidden md:flex flex-grow rounded-r-full py-3 items-center"
          >
            Stats Gallery<svg
              class="w-3 text-gray-400 ml-2"
              viewBox="0 0 14 14"
              fill="none"
              xmlns="http://www.w3.org/2000/svg"
            >
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          href="https://near-in-minutes.com/"
          ><div class="rounded-l-full py-3 pl-4 pr-3 flex">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 20 20"
